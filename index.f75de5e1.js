...
const pushNotification = (posTop, posRight, title, description, type)=>{
    ...
    if (type === "success") container.classList.add("notification", "success");
    else if (type === "error") container.classList.add("notification", "error");
    else if (type === "warning") container.classList.add("notification", "warning");
